/****** Object:  Procedure [EI].[spGenerateEInvoiceSubbiee]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [EI].[spGenerateEInvoiceSubbiee](@HEADERID INT)
AS 
...
SGSTINID INT,SGSTIN VARCHAR(16),SELLERNAME VARCHAR(200),SADDR1 VARCHAR(100),SADDR2 VARCHAR(100),SLOCATION VARCHAR(100),SSTATECODE CHAR(2),SPIN VARCHAR(6),SSTATE VARCHAR(25),
			 ...
			 ORIGINALINVOICENUMBER VARCHAR(25), ORIGINALINVOICEDATE DATETIME,ORIGINALORDERNUMBER VARCHAR(50)
) 
...
FROM EI.EINVOICE WHERE REFERENCEHEADERID=@HEADERID AND  INVOICETYPE<>'INV'
...
UPDATE #EI SET ORIGINALINVOICEDATE = H.INVOICEDATE, ORIGINALINVOICENUMBER = H.INVOICENUMBER , ORIGINALORDERNUMBER=H.ORDERNUMBER 
FROM EI.EINVOICEHEADER H  INNER JOIN #EI ON #EI.HEADERID = H.INVOICEINDEX
SELECT H.FINYEAR,PERIODNAME,
	   ...
	   H.ORIGINALINVOICENUMBER,H.ORIGINALINVOICEDATE,H.ORIGINALORDERNUMBER 
