/****** Object:  Table [BT].[TempSaleSpread]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [BT].[TempSaleSpread](
	[BOQNumber] [varchar](25) NULL,
