/****** Object:  Procedure [BT].[spFetchManpowerSummary]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE BT.spFetchManpowerSummary(@PROJECTID INT,@STARTDATESTRING VARCHAR(15),@ENDDATESTRING VARCHAR(15))
AS
