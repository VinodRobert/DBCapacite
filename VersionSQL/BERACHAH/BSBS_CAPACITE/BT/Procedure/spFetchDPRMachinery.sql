/****** Object:  Procedure [BT].[spFetchDPRMachinery]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [BT].[spFetchDPRMachinery](@PROJECTCODE INT, @DPRDATESTRING  VARCHAR(15)) 
AS
...
IDLEHOURS DECIMAL(18,2), BREAKDOWNHOURS DECIMAL(18,2),OWNERID INT ) 
...
SELECT  DPRID,EQUIPMENTCODE,STARTREADING,ENDREADING,WORKINGHOURS,IDLEHOURS,BREAKDOWNHOURS 
INTO #TEMP1 
FROM BT.DPRMachinery WHERE PROJECTCODE=@PROJECTCODE AND DPRDATE=@DPRDATE 



UPDATE #TEMP0 SET STARTREADING = T.STARTREADING ,ENDREADING = T.ENDREADING,WORKINGHOURS=T.WORKINGHOURS,
IDLEHOURS =T.IDLEHOURS, BREAKDOWNHOURS = T.BREAKDOWNHOURS, DPRID= T.DPRID  
