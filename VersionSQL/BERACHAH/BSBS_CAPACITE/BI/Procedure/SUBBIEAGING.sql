/****** Object:  Procedure [BI].[SUBBIEAGING]    Committed by VersionSQL https://www.versionsql.com ******/

 

CREATE PROCEDURE [BI].[SUBBIEAGING](@AGEDTO INT,  @AGEDTOPERIOD INT, @FINYEAR INT, @AGEOF INT, @LISTCREDITORS  LISTCREDNUMBERS  READONLY  ,@LISTORGIDS  LISTORGIDS READONLY   )  
AS
BEGIN
  ...
  SELECT @CREDITOR_LEDGER = CONTROLFROMGL FROM CONTROLCODES WHERE CONTROLNAME='Sub Contractors'
  ...
  ELSE
    ...
    UPDATE #DUMPS SET RECEIVEDDATE = PDATE WHERE RECEIVEDDATE IS NULL 
	...
	UPDATE #DUMPS SET SUPPLIERNAME = C.SUBNAME FROM SUBCONTRACTORS C INNER JOIN #DUMPS ON #DUMPS.CREDNO = C.SUBNUMBER 
	...
	SET @INDEXID = 1
	-- MODIFIED THE LOGIC ON 26 AUGUST 2020 
	-- THE ELSE PORTION WAS PREVIOUSLY NEGATIVE ; BUT MODIFIED AS POSITIVE  
	   ...
	   IF  @UNMATCHEDVALUE > 0 
	    BEGIN
		  ...
		  ELSE
		    BEGIN
			    SET @UNMATCHEDVALUE = @UNMATCHEDVALUE+ @OLDCELLVALUE 
				-- MODIFIED ON 26 AUGUST 2020 - PREVISOULY IT WAS NEGATIVE - BUT NOW MAKING POSITIVE   OLD ENTRY @UNMATCHEDVALUE-@OLDCELLVALUE
	...
	DELETE FROM #FINALEXPORT WHERE  BUCKET0=0 AND BUCKET1=0 AND BUCKET2=0 AND BUCKET3=0 AND BUCKET4=0 AND BUCKET5=0 AND BUCKET6=0 AND BUCKET7=0 AND  UNMATCHED =0    
	DELETE FROM #FINALCONSOLIDATED WHERE BUCKET0=0 AND BUCKET1=0 AND BUCKET2=0 AND BUCKET3=0 AND BUCKET4=0 AND BUCKET5=0 AND BUCKET6=0 AND BUCKET7=0 AND  UNMATCHED =0 
	DELETE FROM #FINALCONSOLIDATEDORGLEVEL WHERE BUCKET0=0 AND BUCKET1=0 AND BUCKET2=0 AND BUCKET3=0 AND BUCKET4=0 AND BUCKET5=0 AND BUCKET6=0 AND BUCKET7=0 AND  UNMATCHED =0 
