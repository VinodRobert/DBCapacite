/****** Object:  Procedure [BI].[spSubContractorRegister]    Committed by VersionSQL https://www.versionsql.com ******/

 
CREATE PROCEDURE [BI].[spSubContractorRegister](@FINYEAR INT, @FROMPERIOD INT,@TOPERIOD INT, @LISTCREDITORS  LISTCREDNUMBERS  READONLY  ,@LISTORGIDS  LISTORGIDS READONLY   )
As
 --DECLARE @FINYEAR INT
...
WHERE 
 ...
 T.CREDNO IN (SELECT CREDNUMBER FROM #PARTYCODES) 
