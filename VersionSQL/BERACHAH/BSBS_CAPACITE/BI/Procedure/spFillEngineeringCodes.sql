/****** Object:  Procedure [BI].[spFillEngineeringCodes]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE  [BI].[spFillEngineeringCodes](@RECONID INT ) 
AS
...
BEGIN 
	...
	SELECT ACTNUMBER,ACTNAME,0 FROM ACTIVITIES WHERE LEFT(ACTNUMBER,4)='4000' 
