/****** Object:  Procedure [BI].[spSubbieDoneTrans]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [BI].[spSubbieDoneTrans](@FINYEAR INT)
AS
--SELECT 
-- DISTINCT CREDNO  
-- INTO #TEMP0 
...
SELECT SUBNUMBER CREDNUMBER,( LTRIM(RTRIM(UPPER(SUBNAME)))+' - '+LTRIM(RTRIM(UPPER(SUBNUMBER))) ) CREDNAME FROM SUBCONTRACTORS  ORDER BY CREDNAME 
