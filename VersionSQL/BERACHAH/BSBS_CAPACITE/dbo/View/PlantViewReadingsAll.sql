/****** Object:  View [dbo].[PlantViewReadingsAll]    Committed by VersionSQL https://www.versionsql.com ******/

create VIEW [dbo].[PlantViewReadingsAll]
AS
...
UNION ALL
SELECT     dbo.PlantHireReturns.PeNumber, dbo.PlantHireReturns.HireRSMRDate, ISNULL(dbo.PlantHireReturns.HireRSMRReading, - 1) AS HireRSMRReading, 
                     0 AS IsService, NULL AS ServID, CONVERT(nvarchar, dbo.PlantHireReturns.HireRNumber) AS ID, 'ReqBased' AS [Where], PLANTCATEGORIES_1.SMRUnit, 
...
FROM         dbo.PlantHireDetail INNER JOIN
                     dbo.PlantHireReturnsHead ON dbo.PlantHireDetail.HireHNumber = dbo.PlantHireReturnsHead.HireHNumber AND 
                     dbo.PlantHireDetail.PeNumber = dbo.PlantHireReturnsHead.PeNumber INNER JOIN
                     dbo.PlantHireReturns ON dbo.PlantHireReturnsHead.HireRNumber = dbo.PlantHireReturns.HireRNumber INNER JOIN
                     ...
                     dbo.USERS AS USERS_2 ON dbo.PlantHireReturns.HireRPostUserID = USERS_2.USERID LEFT OUTER JOIN
...
GROUP BY dbo.PlantHireReturns.PeNumber, dbo.PlantHireReturns.HireRSMRDate, ISNULL(dbo.PlantHireReturns.HireRSMRReading, - 1), 
                     dbo.PlantHireReturns.HireRNumber, PLANTCATEGORIES_1.SMRUnit, dbo.PlantHireDetail.HireHNumber, USERS_2.USERNAME, 
                     ...
                     N'N/A')))), dbo.PlantHireReturns.HireRPostUserID
UNION ALL
