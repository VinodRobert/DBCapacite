/****** Object:  Procedure [dbo].[VR791]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[VR791]
AS            
DECLARE @ASSETID INT
DECLARE @LASTCOUNT INT
DECLARE ASSETREC CURSOR FOR 
SELECT DISTINCT ASSETID FROM BI.ASSETPOSTS  ORDER BY ASSETID 
OPEN ASSETREC 
...
BEGIN
	...
	UPDATE BI.ASSETPOSTS  SET CURRNETCOUNT= @LASTCOUNT-9 WHERE  ASSETID=@ASSETID AND PERIOD=1
