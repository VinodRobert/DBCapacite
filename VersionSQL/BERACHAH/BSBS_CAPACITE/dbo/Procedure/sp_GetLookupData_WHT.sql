/****** Object:  Procedure [dbo].[sp_GetLookupData_WHT]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author: Riaan Engelbrecht
-- Create date: 06-11-2020
-- Description:	Returns the wht lookup data 
-- NOTES:
-- 2020-06-11 RiaanE
--  Added the procedure
-- =============================================
CREATE PROCEDURE [dbo].[sp_GetLookupData_WHT] (
@PageNo INT = 1, 
...
BEGIN
  ...
  @TotalPages BIGINT = -1
	...
	SET @ExecSql = 'SELECT TAXWHT.WHTID whtid, TAXWHT.CODE code, TAXWHT.SECTION section, TAXWHT.DESCRIPTION description, TAXWHT.RATE1 + TAXWHT.RATE2 + TAXWHT.RATE3 AS rate, threshold 
	' + 'FROM TAXWHT 
	' + 'where 1=1 ';	
