/****** Object:  Table [dbo].[MOZFISCALCODES]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[MOZFISCALCODES](
	[FiscalCode] [char](15) NULL,
	[FiscalDescription] [nvarchar](80) NULL,
	[FiscalID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[Summ] [bit] NOT NULL,
 CONSTRAINT [PK_MOZFISCALCODES] PRIMARY KEY CLUSTERED 
(
	[FiscalID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[MOZFISCALCODES] ADD  CONSTRAINT [DF_MOZFISCALCODES_FISCALCODE]  DEFAULT ('') FOR [FiscalCode]
ALTER TABLE [dbo].[MOZFISCALCODES] ADD  CONSTRAINT [DF_MOZFISCALCODES_FISCALDESCRIPTION]  DEFAULT ('') FOR [FiscalDescription]
ALTER TABLE [dbo].[MOZFISCALCODES] ADD  CONSTRAINT [DF_MOZFISCALCODES_Summ]  DEFAULT (0) FOR [Summ]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERMOZFISCALCODES ON MOZFISCALCODES
...
ALTER TABLE [dbo].[MOZFISCALCODES] ENABLE TRIGGER [LOGMASTERMOZFISCALCODES]