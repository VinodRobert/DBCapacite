/****** Object:  Table [dbo].[USERADMINPROCESSES]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[USERADMINPROCESSES](
	[PID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[PROCESS] [nvarchar](55) NOT NULL,
	[USERID] [int] NOT NULL,
	[ALLOW] [int] NOT NULL,
	[ORGID] [int] NOT NULL,
 CONSTRAINT [PK_USERADMINPROCESSES] PRIMARY KEY CLUSTERED 
(
	[PID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[USERADMINPROCESSES] ADD  CONSTRAINT [DF_USERADMINPROCESSES_PROCESS]  DEFAULT ('') FOR [PROCESS]
ALTER TABLE [dbo].[USERADMINPROCESSES] ADD  CONSTRAINT [DF_USERADMINPROCESSES_USERID]  DEFAULT ('-1') FOR [USERID]
ALTER TABLE [dbo].[USERADMINPROCESSES] ADD  CONSTRAINT [DF_USERADMINPROCESSES_ALLOW]  DEFAULT ('0') FOR [ALLOW]
ALTER TABLE [dbo].[USERADMINPROCESSES] ADD  CONSTRAINT [DF_USERADMINPROCESSES_ORGID]  DEFAULT ('-1') FOR [ORGID]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERUSERADMINPROCESSES ON USERADMINPROCESSES
...
set @tableName = 'USERADMINPROCESSES'
set @primaryKey = 'PID'
set @ignoreList = ''
...
ALTER TABLE [dbo].[USERADMINPROCESSES] ENABLE TRIGGER [LOGMASTERUSERADMINPROCESSES]