/****** Object:  Table [dbo].[WORKFLOWLEDGERCODERANGERS]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[WORKFLOWLEDGERCODERANGERS](
	[WLCID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[BORGID] [int] NOT NULL,
	[DESCR] [nvarchar](250) NOT NULL,
	[ALLOC] [nvarchar](15) NOT NULL,
	[FROMLC] [nvarchar](10) NOT NULL,
	[TOLC] [nvarchar](10) NOT NULL,
 CONSTRAINT [PK_WORKFLOWLEDGERCODERANGERS] PRIMARY KEY CLUSTERED 
(
	[WLCID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[WORKFLOWLEDGERCODERANGERS] ADD  CONSTRAINT [DF_WORKFLOWLEDGERCODERANGERS_BORGID]  DEFAULT ((-1)) FOR [BORGID]
ALTER TABLE [dbo].[WORKFLOWLEDGERCODERANGERS] ADD  CONSTRAINT [DF_WORKFLOWLEDGERCODERANGERS_DESCR]  DEFAULT ('') FOR [DESCR]
ALTER TABLE [dbo].[WORKFLOWLEDGERCODERANGERS] ADD  CONSTRAINT [DF_WORKFLOWLEDGERCODERANGERS_ALLOC]  DEFAULT ('') FOR [ALLOC]
ALTER TABLE [dbo].[WORKFLOWLEDGERCODERANGERS] ADD  CONSTRAINT [DF_WORKFLOWLEDGERCODERANGERS_FROMLC]  DEFAULT ('') FOR [FROMLC]
ALTER TABLE [dbo].[WORKFLOWLEDGERCODERANGERS] ADD  CONSTRAINT [DF_WORKFLOWLEDGERCODERANGERS_TOLC]  DEFAULT ('') FOR [TOLC]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERWORKFLOWLEDGERCODERANGERS ON WORKFLOWLEDGERCODERANGERS
...
set @tableName = 'WORKFLOWLEDGERCODERANGERS'
set @primaryKey = 'WLCID'
set @ignoreList = ''
...
ALTER TABLE [dbo].[WORKFLOWLEDGERCODERANGERS] ENABLE TRIGGER [LOGMASTERWORKFLOWLEDGERCODERANGERS]