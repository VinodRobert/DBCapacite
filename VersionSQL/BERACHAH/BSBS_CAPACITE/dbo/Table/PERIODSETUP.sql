/****** Object:  Table [dbo].[PERIODSETUP]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[PERIODSETUP](
	...
	[STATUS] [int] NOT NULL,
 CONSTRAINT [PK_PERIODSETUP] PRIMARY KEY CLUSTERED 
(
	[PSID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[PERIODSETUP] ADD  CONSTRAINT [DF_PERIODSETUP_ORGID]  DEFAULT ((-1)) FOR [ORGID]
ALTER TABLE [dbo].[PERIODSETUP] ADD  CONSTRAINT [DF_PERIODSETUP_YEAR]  DEFAULT ((-1)) FOR [YEAR]
ALTER TABLE [dbo].[PERIODSETUP] ADD  CONSTRAINT [DF_PERIODSETUP_PERIOD]  DEFAULT ((-1)) FOR [PERIOD]
ALTER TABLE [dbo].[PERIODSETUP] ADD  CONSTRAINT [DF_PERIODSETUP_DESCR]  DEFAULT ('') FOR [DESCR]
ALTER TABLE [dbo].[PERIODSETUP] ADD  CONSTRAINT [DF_PERIODSETUP_ISYEAREND]  DEFAULT ('0') FOR [ISYEAREND]
ALTER TABLE [dbo].[PERIODSETUP] ADD  CONSTRAINT [DF_PERIODSETUP_PEDATE]  DEFAULT (getdate()) FOR [PEDATE]
ALTER TABLE [dbo].[PERIODSETUP] ADD  CONSTRAINT [DF_PERIODSETUP_STATUS]  DEFAULT ((0)) FOR [STATUS]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERPERIODSETUP ON PERIODSETUP
...
ALTER TABLE [dbo].[PERIODSETUP] ENABLE TRIGGER [LOGMASTERPERIODSETUP]