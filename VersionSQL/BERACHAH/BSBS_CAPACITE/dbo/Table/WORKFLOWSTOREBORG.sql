/****** Object:  Table [dbo].[WORKFLOWSTOREBORG]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[WORKFLOWSTOREBORG](
	[WSBID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[BORGID] [int] NOT NULL,
	[STORECODE] [nvarchar](15) NOT NULL,
 CONSTRAINT [PK_WORKFLOWSTOREBORG] PRIMARY KEY CLUSTERED 
(
	[WSBID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[WORKFLOWSTOREBORG] ADD  CONSTRAINT [DF_WORKFLOWSTOREBORG_BORGID]  DEFAULT ((-1)) FOR [BORGID]
ALTER TABLE [dbo].[WORKFLOWSTOREBORG] ADD  CONSTRAINT [DF_WORKFLOWSTOREBORG_STORECODE]  DEFAULT ('') FOR [STORECODE]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERWORKFLOWSTOREBORG ON WORKFLOWSTOREBORG
...
set @tableName = 'WORKFLOWSTOREBORG'
set @primaryKey = 'WSBID'
set @ignoreList = ''
...
ALTER TABLE [dbo].[WORKFLOWSTOREBORG] ENABLE TRIGGER [LOGMASTERWORKFLOWSTOREBORG]