/****** Object:  Table [dbo].[VERSIONS]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[VERSIONS](
	[APPLICATION] [nvarchar](3) NOT NULL,
	[LASTVER] [nvarchar](15) NOT NULL,
...
ALTER TABLE [dbo].[VERSIONS] ADD  CONSTRAINT [DF_VERSIONS_APPLICATION]  DEFAULT ('') FOR [APPLICATION]
ALTER TABLE [dbo].[VERSIONS] ADD  CONSTRAINT [DF_VERSIONS_LASTVER]  DEFAULT ('') FOR [LASTVER]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERVERSIONS ON VERSIONS
...
ALTER TABLE [dbo].[VERSIONS] ENABLE TRIGGER [LOGMASTERVERSIONS]