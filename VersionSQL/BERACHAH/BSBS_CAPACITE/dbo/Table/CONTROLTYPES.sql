/****** Object:  Table [dbo].[CONTROLTYPES]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE TABLE [dbo].[CONTROLTYPES](
	...
	[ISINCOMESTATEMENT] [bit] NOT NULL,
...
ALTER TABLE [dbo].[CONTROLTYPES] ADD  CONSTRAINT [DF_CONTROLTYPES_DISPLAYNAME]  DEFAULT ('') FOR [DISPLAYNAME]
ALTER TABLE [dbo].[CONTROLTYPES] ADD  CONSTRAINT [DF_CONTROLTYPES_SEQ]  DEFAULT ('0') FOR [SEQ]
ALTER TABLE [dbo].[CONTROLTYPES] ADD  CONSTRAINT [DF_CONTROLTYPES_ISINCOMESTATEMENT]  DEFAULT ('1') FOR [ISINCOMESTATEMENT]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERCONTROLTYPES ON CONTROLTYPES
...
ALTER TABLE [dbo].[CONTROLTYPES] ENABLE TRIGGER [LOGMASTERCONTROLTYPES]