/****** Object:  Table [dbo].[USERSINBORG]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[USERSINBORG](
	[USERID] [int] NOT NULL,
	[BORGID] [int] NOT NULL,
 ...
 CONSTRAINT [PK_USERSINORG] PRIMARY KEY NONCLUSTERED 
(
	[USERID] ASC,
	[BORGID] ASC
...
ALTER TABLE [dbo].[USERSINBORG] ADD  CONSTRAINT [DF_USERSINBORG_SPENDINGLIMIT]  DEFAULT (0) FOR [SPENDINGLIMIT]
ALTER TABLE [dbo].[USERSINBORG] ADD  CONSTRAINT [DF_USERSINBORG_BILLTOID]  DEFAULT ((-1)) FOR [BILLTOID]
ALTER TABLE [dbo].[USERSINBORG] ADD  CONSTRAINT [DF_USERSINBORG_SHIPTOID]  DEFAULT ((-1)) FOR [SHIPTOID]
ALTER TABLE [dbo].[USERSINBORG] ADD  CONSTRAINT [DF_USERSINBORG_SPENDLIMITAPPROVER]  DEFAULT ((-1)) FOR [SPENDLIMITAPPROVER]
ALTER TABLE [dbo].[USERSINBORG] ADD  CONSTRAINT [DF_USERSINBORG_APPROVALLIMIT]  DEFAULT (0) FOR [APPROVALLIMIT]
ALTER TABLE [dbo].[USERSINBORG] ADD  CONSTRAINT [DF_USERSINBORG_ROLEID]  DEFAULT ((-1)) FOR [ROLEID]
ALTER TABLE [dbo].[USERSINBORG] ADD  CONSTRAINT [DF_USERSINBORG_CANOVERDLVR]  DEFAULT (1) FOR [CANOVERDLVR]
ALTER TABLE [dbo].[USERSINBORG] ADD  DEFAULT ((0)) FOR [EXTPO]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERUSERSINBORG ON USERSINBORG
...
ALTER TABLE [dbo].[USERSINBORG] ENABLE TRIGGER [LOGMASTERUSERSINBORG]