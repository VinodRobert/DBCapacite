/****** Object:  Table [dbo].[ACTIVITIES]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[ACTIVITIES](
	[ActNumber] [char](10) NOT NULL,
	[ActName] [char](35) NULL,
	[TOJOINA] [int] NOT NULL,
	[ActID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[ACTUNIT] [char](10) NOT NULL,
	[ACTSTATUS] [int] NOT NULL,
 CONSTRAINT [PK_ACTIVITIES] PRIMARY KEY NONCLUSTERED 
(
	[ActNumber] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY],
 CONSTRAINT [IX_ACTIVITIES] UNIQUE NONCLUSTERED 
(
	[ActID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[ACTIVITIES] ADD  CONSTRAINT [DF_ACTIVITIES_TOJOINA]  DEFAULT (9) FOR [TOJOINA]
ALTER TABLE [dbo].[ACTIVITIES] ADD  DEFAULT ('') FOR [ACTUNIT]
ALTER TABLE [dbo].[ACTIVITIES] ADD  CONSTRAINT [DF_ACTIVITIES_ACTSTATUS]  DEFAULT ((0)) FOR [ACTSTATUS]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERACTIVITIES ON ACTIVITIES
...
ALTER TABLE [dbo].[ACTIVITIES] ENABLE TRIGGER [LOGMASTERACTIVITIES]