/****** Object:  Table [dbo].[WORKFLOWHEADER]    Committed by VersionSQL https://www.versionsql.com ******/
...
ALTER TABLE [dbo].[WORKFLOWHEADER] ADD  CONSTRAINT [DF_WORKFLOWHEADER_DESCR]  DEFAULT ('') FOR [DESCR]
ALTER TABLE [dbo].[WORKFLOWHEADER] ADD  CONSTRAINT [DF_WORKFLOWHEADER_ALLOC]  DEFAULT ('') FOR [ALLOC]
ALTER TABLE [dbo].[WORKFLOWHEADER] ADD  CONSTRAINT [DF_WORKFLOWHEADER_PROC]  DEFAULT ('') FOR [PROC]
ALTER TABLE [dbo].[WORKFLOWHEADER] ADD  CONSTRAINT [DF_WORKFLOWHEADER_SUBTYPE]  DEFAULT ('') FOR [SUBTYPE]
ALTER TABLE [dbo].[WORKFLOWHEADER] ADD  CONSTRAINT [DF_WORKFLOWHEADER_SENDMAIL]  DEFAULT (N'0') FOR [SENDMAIL]
ALTER TABLE [dbo].[WORKFLOWHEADER] ADD  CONSTRAINT [DF_WORKFLOWHEADER_PREAPPROVAL]  DEFAULT ((-1)) FOR [PREAPPROVAL]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERWORKFLOWHEADER ON WORKFLOWHEADER
...
ALTER TABLE [dbo].[WORKFLOWHEADER] ENABLE TRIGGER [LOGMASTERWORKFLOWHEADER]