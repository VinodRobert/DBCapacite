...
CREATE TABLE [dbo].[PROJECTS](
	[ProjNumber] [char](10) NOT NULL,
	[ProjName] [nvarchar](50) NOT NULL,
	[ProjCommence] [datetime] NOT NULL,
	[ProjDuration] [int] NOT NULL,
	[ProjContact] [int] NOT NULL,
	[PROJID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[BORGID] [int] NOT NULL,
...
CREATE TRIGGER LOGMASTERPROJECTS ON PROJECTS
...
ALTER TABLE [dbo].[PROJECTS] ENABLE TRIGGER [LOGMASTERPROJECTS]