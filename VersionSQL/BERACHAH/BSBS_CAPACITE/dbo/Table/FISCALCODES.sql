/****** Object:  Table [dbo].[FISCALCODES]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[FISCALCODES](
	[FiscalCode] [char](15) NULL,
	[FiscalDescription] [nvarchar](80) NULL,
	[FiscalID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[Summ] [bit] NOT NULL,
	[POC] [nvarchar](10) NOT NULL,
 CONSTRAINT [PK_FISCALCODES] PRIMARY KEY CLUSTERED 
(
	[FiscalID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[FISCALCODES] ADD  CONSTRAINT [DF_FISCALCODES_FISCALCODE]  DEFAULT ('') FOR [FiscalCode]
ALTER TABLE [dbo].[FISCALCODES] ADD  CONSTRAINT [DF_FISCALCODES_FISCALDESCRIPTION]  DEFAULT ('') FOR [FiscalDescription]
ALTER TABLE [dbo].[FISCALCODES] ADD  CONSTRAINT [DF_FISCALCODES_Summ]  DEFAULT ((0)) FOR [Summ]
ALTER TABLE [dbo].[FISCALCODES] ADD  CONSTRAINT [DF_FISCALCODES_POC]  DEFAULT ('') FOR [POC]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERFISCALCODES ON FISCALCODES
...
set @tableName = 'FISCALCODES'
set @primaryKey = 'FiscalID'
set @ignoreList = ''
...
ALTER TABLE [dbo].[FISCALCODES] ENABLE TRIGGER [LOGMASTERFISCALCODES]