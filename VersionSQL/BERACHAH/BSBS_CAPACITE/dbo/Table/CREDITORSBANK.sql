/****** Object:  Table [dbo].[CREDITORSBANK]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[CREDITORSBANK](
	...
	[ISNEW] [int] NOT NULL,
 CONSTRAINT [PK_CREDITORSBANK] PRIMARY KEY CLUSTERED 
(
	[CredBankOrgID] ASC,
	[CredNumber] ASC
...
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_CredBankOrgID]  DEFAULT ((-1)) FOR [CredBankOrgID]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_CredBank]  DEFAULT ((-1)) FOR [CredBank]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_CREDBRANCH]  DEFAULT ('') FOR [CredBranch]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_CREDACCNUMBER]  DEFAULT ('') FOR [CredAccNumber]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_CredAccType]  DEFAULT (1) FOR [CredAccType]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_CredRef]  DEFAULT ('') FOR [CredRef]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  DEFAULT ('') FOR [STANDARDBANK_PROFILE]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_SWIFT]  DEFAULT ('') FOR [SWIFT]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_IFSC]  DEFAULT ('') FOR [IFSC]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_SYSDATE]  DEFAULT (getdate()) FOR [SYSDATE]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_USERID]  DEFAULT ((-1)) FOR [USERID]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_STATUS]  DEFAULT ((0)) FOR [STATUS]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_APPROVALCOMMENT]  DEFAULT ('') FOR [APPROVALCOMMENT]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_SUSPEND]  DEFAULT (N'0') FOR [SUSPEND]
ALTER TABLE [dbo].[CREDITORSBANK] ADD  CONSTRAINT [DF_CREDITORSBANK_ISNEW]  DEFAULT ((0)) FOR [ISNEW]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERCREDITORSBANK ON CREDITORSBANK
...
BEGIN		  
  ...
  If @Rows > 0 
    ...
    INSERT INTO [CREDITORSBANKAPPROVAL] (
    ...
    FROM CREDITORSBANK 
		...
		UPDATE CREDITORSBANK 
		SET STATUS = CASE WHEN B.USEBANKAPPROVALS = 1 then 2 else CREDITORSBANK.STATUS end,
    SYSDATE = getDate(), 
    USERID = I.USERID, 
    APPROVALCOMMENT = ''
		FROM CREDITORSBANK 
...
BEGIN
  ...
  BEGIN  
    UPDATE CREDITORSBANK 
    SET ISNEW = CREDITORSBANK.STATUS
    FROM CREDITORSBANK 
    INNER JOIN #inserted I on CREDITORSBANK.CREDBANKID = I.CREDBANKID
    WHERE CREDITORSBANK.STATUS = 1
  END
...
ALTER TABLE [dbo].[CREDITORSBANK] ENABLE TRIGGER [LOGMASTERCREDITORSBANK]