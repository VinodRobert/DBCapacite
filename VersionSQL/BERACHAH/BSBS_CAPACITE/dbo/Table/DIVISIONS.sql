/****** Object:  Table [dbo].[DIVISIONS]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[DIVISIONS](
	[BorgID] [int] NOT NULL,
	[DivID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[DivName] [char](55) NOT NULL,
	[DivParent] [int] NOT NULL,
	[tojoinDiv] [int] NOT NULL,
	[IsWorkshop] [bit] NULL,
	[JobCardIndex] [int] NULL,
	[JobCardPrefix] [char](4) NULL,
	[JDECODE] [char](10) NULL,
	[ISSTOCKHIREDIV] [bit] NOT NULL,
	[DIVSTATUS] [int] NOT NULL,
	[DIVCODE] [nvarchar](10) NOT NULL,
...
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF_DIVISIONS_BorgID]  DEFAULT (1) FOR [BorgID]
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF_DIVISIONS_DivName]  DEFAULT ('') FOR [DivName]
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF_DIVISIONS_DivParent]  DEFAULT ((-1)) FOR [DivParent]
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF_DIVISIONS_tojoinDiv]  DEFAULT (25) FOR [tojoinDiv]
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF__DIVISIONS__IsWor__53659CE6]  DEFAULT (0) FOR [IsWorkshop]
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF__DIVISIONS__JobCa__5459C11F]  DEFAULT (0) FOR [JobCardIndex]
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF__DIVISIONS__JobCa__67378B69]  DEFAULT (null) FOR [JobCardPrefix]
ALTER TABLE [dbo].[DIVISIONS] ADD  DEFAULT ('') FOR [JDECODE]
ALTER TABLE [dbo].[DIVISIONS] ADD  DEFAULT ('0') FOR [ISSTOCKHIREDIV]
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF_DIVISIONS_DIVSTATUS]  DEFAULT ((0)) FOR [DIVSTATUS]
ALTER TABLE [dbo].[DIVISIONS] ADD  CONSTRAINT [DF_DIVISIONS_DIVCODE]  DEFAULT ('') FOR [DIVCODE]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERDIVISIONS ON DIVISIONS
...
ALTER TABLE [dbo].[DIVISIONS] ENABLE TRIGGER [LOGMASTERDIVISIONS]