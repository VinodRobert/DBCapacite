/****** Object:  Table [dbo].[CONTROLCODES]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[CONTROLCODES](
	[ControlID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	[ControlName] [char](35) NULL,
	[ControlPlant] [bit] NOT NULL,
	[ControlContract] [bit] NOT NULL,
	[ControlPayroll] [bit] NOT NULL,
	[ControlFromGL] [char](10) NULL,
	[ControlToGL] [char](10) NULL,
	[COMMENT] [char](80) NOT NULL,
 CONSTRAINT [PK_CONTROLCODES] PRIMARY KEY CLUSTERED 
(
	[ControlID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[CONTROLCODES] ADD  CONSTRAINT [DF_CONTROLCODES_ControlPlant]  DEFAULT (0) FOR [ControlPlant]
ALTER TABLE [dbo].[CONTROLCODES] ADD  CONSTRAINT [DF_CONTROLCODES_ControlContract]  DEFAULT (0) FOR [ControlContract]
ALTER TABLE [dbo].[CONTROLCODES] ADD  CONSTRAINT [DF_CONTROLCODES_ControlPayroll]  DEFAULT (0) FOR [ControlPayroll]
ALTER TABLE [dbo].[CONTROLCODES] ADD  DEFAULT ('') FOR [COMMENT]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERCONTROLCODES ON CONTROLCODES
...
set @tableName = 'CONTROLCODES'
set @primaryKey = 'ControlID'
set @ignoreList = ''
...
ALTER TABLE [dbo].[CONTROLCODES] ENABLE TRIGGER [LOGMASTERCONTROLCODES]