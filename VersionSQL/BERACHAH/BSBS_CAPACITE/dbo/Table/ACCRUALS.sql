/****** Object:  Table [dbo].[ACCRUALS]    Committed by VersionSQL https://www.versionsql.com ******/
...
ALTER TABLE [dbo].[ACCRUALS] ADD  CONSTRAINT [DF_ACCRUALS_BORGID]  DEFAULT ('-1') FOR [BORGID]
ALTER TABLE [dbo].[ACCRUALS] ADD  CONSTRAINT [DF_ACCRUALS_ACCRUAL]  DEFAULT ('') FOR [ACCRUAL]
ALTER TABLE [dbo].[ACCRUALS] ADD  CONSTRAINT [DF_ACCRUALS_INUSE]  DEFAULT ('0') FOR [INUSE]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERACCRUALS ON ACCRUALS
...
ALTER TABLE [dbo].[ACCRUALS] ENABLE TRIGGER [LOGMASTERACCRUALS]