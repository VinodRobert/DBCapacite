/****** Object:  Table [dbo].[UOM]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [dbo].[UOM](
	[UOMID] [int] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
...
(
 ...
 CONSTRAINT [IX_UOM] UNIQUE NONCLUSTERED 
(
	[UOMCODE] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[UOM] ADD  CONSTRAINT [DF_UOM_IsActive]  DEFAULT ((0)) FOR [ISACTIVE]
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

CREATE TRIGGER LOGMASTERUOM ON UOM
...
ALTER TABLE [dbo].[UOM] ENABLE TRIGGER [LOGMASTERUOM]