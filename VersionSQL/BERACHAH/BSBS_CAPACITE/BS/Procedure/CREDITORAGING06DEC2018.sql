/****** Object:  Procedure [BS].[CREDITORAGING06DEC2018]    Committed by VersionSQL https://www.versionsql.com ******/

 

CREATE PROCEDURE [BS].[CREDITORAGING06DEC2018](@YEAR INT,@ZONE INT)
AS
BEGIN
