/****** Object:  Procedure [BS].[CREDITORAGING_ORGWISE]    Committed by VersionSQL https://www.versionsql.com ******/

 

CREATE PROCEDURE [BS].[CREDITORAGING_ORGWISE](@YEAR INT,@ORGID INT)
AS
BEGIN
