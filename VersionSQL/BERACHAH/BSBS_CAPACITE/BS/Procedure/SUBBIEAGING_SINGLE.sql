/****** Object:  Procedure [BS].[SUBBIEAGING_SINGLE]    Committed by VersionSQL https://www.versionsql.com ******/

 

CREATE PROCEDURE [BS].[SUBBIEAGING_SINGLE](@YEAR INT,@CREDNO VARCHAR(10),@ZONE INT ) 
AS
BEGIN
