/****** Object:  Procedure [BS].[SUBBIEAGING]    Committed by VersionSQL https://www.versionsql.com ******/

 

CREATE PROCEDURE [BS].[SUBBIEAGING](@YEAR INT,@ZONE INT)
AS
BEGIN
	...
	UPDATE #TEMP0 SET BORGNAME = B.BORGNAME FROM BORGS  B INNER JOIN #TEMP0 ON #TEMP0.ORGID=B.BORGID 
	 ...
	 UPDATE #TEMP1 SET SUPPLIERNAME = S.SUBNAME   FROM SUBCONTRACTORS S INNER JOIN #TEMP1 ON #TEMP1.SUPPLIER = S.SUBNUMBER  
