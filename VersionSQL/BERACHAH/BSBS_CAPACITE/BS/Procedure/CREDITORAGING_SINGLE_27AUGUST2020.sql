/****** Object:  Procedure [BS].[CREDITORAGING_SINGLE_27AUGUST2020]    Committed by VersionSQL https://www.versionsql.com ******/

 

CREATE PROCEDURE [BS].[CREDITORAGING_SINGLE_27AUGUST2020](@YEAR INT,@CREDNO VARCHAR(10),@ZONE INT ) 
AS
BEGIN
	...
	--SELECT SUM(OUTSTANDINGAMOUNT) FROM #TEMP0 WHERE ORGID=93
	--SELECT SUM(CREDIT) FROM TRANSACTIONS WHERE YEAR=2019 AND CREDNO='AAMCS9233Q'  AND ORGID=93 AND LEDGERCODE='1315000' 
	
	SELECT * FROM #TEMP0 WHERE YEAR>@YEAR AND FINMONTH =0 
