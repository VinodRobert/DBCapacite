/****** Object:  Procedure [BS].[CREDITORAGING_SINGLE_04JAN2019]    Committed by VersionSQL https://www.versionsql.com ******/

 

CREATE PROCEDURE [BS].[CREDITORAGING_SINGLE_04JAN2019](@YEAR INT,@CREDNO VARCHAR(10),@ZONE INT ) 
AS
BEGIN
