/****** Object:  Procedure [BS].[spGenerateSiteEstablishment]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [BS].[spGenerateSiteEstablishment](@BORGID INT)
AS
...
SET @FILENAME = 'BSBS_TEMP.DBO.SITEESTABLISHMENT'
...
WHERE LEFT(A.ASSETCATEGORY,2)='SE' AND A.BORGID=@BORGID
...
SET @SQL = 'SELECT *  INTO '+@FILENAME+ ' FROM   #TEMP0   ORDER BY ASSETCATEGORY,ASSETNUMBER '
