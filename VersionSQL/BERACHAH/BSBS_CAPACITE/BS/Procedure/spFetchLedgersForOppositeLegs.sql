...
AS
SELECT LEDGERCODE,LTRIM(RTRIM(LEDGERNAME)) LEDGERNAME INTO #TEMP0 FROM LEDGERCODES  WHERE LEDGERALLOC IN ('BALANCE SHEET','CONTRACTS') AND LEDGERSUMMARY=0
...
SELECT * FROM #TEMP0 ORDER BY LEDGERCODE 